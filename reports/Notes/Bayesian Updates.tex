...
\[
\mathbb{P}(Y = y| \theta = \mu)  = \frac{1}{2}\left[1 + (-1)^y e^{- (2k +1) \zeta} \cos((4k+2) \mu)\right]
\] 
...
\begin{align*}
	...
	\mu_{y}(\mu, \sigma^2) &= \frac{\mu + (-1)^y e^{-\lambda \zeta} e^{-\frac{1}{2}\lambda^lo2\sigma^2}\big(\mu\cos(\lambda\mu) - \sigma^2\lambda \sin(\lambda\mu)\big)}{1+(-1)^y e^{-\lambda \zeta} e^{-\frac{1}{2}\lambda^2\sigma^2}\cos(\lambda\mu)} \\
