...
{\color{purple} (to be written once we know what's in the rest of the paper)}
 ...
 The key idea is the use of an online optimisation procedure to recursively generate a sampling strategy, both number of samples and  the circuit depth for each sample, to minimise the total work required  
