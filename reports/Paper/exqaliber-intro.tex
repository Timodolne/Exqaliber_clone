...
\camille{I don't think we should bring up the math in the first paragraph. Maybe we can keep it a bit more high-level.}
...
\camille{Monte Carlo is a way to estimate a general integral, right? Not just the mean.}
...
\camille{We should be consistent in using $k$ or $m$. Later, Joe and I talk about $k$.}
...
\]
\camille{Here we have the $4$ again, instead of the $2$.}
