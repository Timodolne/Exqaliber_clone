...
In this paper,\replaced[id=jlt]{the novel work is in the sampling procedure and the associated modelling}{we demonstrate a novel method for}. For the post-processing we use the maximum likelihood estimate (MLE) originally described in \cite{MLE}. For this reason here we concentrate on the sampling algorithm and include a short introduction to the MLE at the end of this section.
