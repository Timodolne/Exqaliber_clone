...
htmlhelp_basename = "Exqaliberdoc"
...
# [howto/manual]).
latex_documents = [
    ("index", "Exqaliber.tex", "Exqaliber Documentation", "jlt3", "manual"),
]
...
man_pages = [("index", "Exqaliber", "Exqaliber Documentation", ["jlt3"], 1)]
...
texinfo_documents = [
    (
        "index",
        "Exqaliber",
        "Exqaliber Documentation",
        "jlt3",
        "Exqaliber",
        "Implementation of a transfer learning scheme for quantum natural"
